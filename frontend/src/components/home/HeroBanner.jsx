      ...
      <div className="relative h-full container-luxury flex items-center">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            >
              <Link to={slide.ctaLink} className="btn-gold text-base">
              ...
              <a
                ...
                className="flex items-center gap-2 px-8 h-12 rounded-full border-2 border-white/40 text-cream font-poppins font-semibold text-base hover:border-white hover:bg-white/10 transition-all duration-300"
              >
