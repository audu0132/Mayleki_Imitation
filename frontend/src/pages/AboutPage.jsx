    ...
    <>
      ...
      <main className="bg-[#FAF7F2] dark:bg-[#141110] min-h-screen" role="main" aria-label="About Mayleki Heritage">
        ...
        <div className="relative overflow-hidden min-h-[55vh] flex items-center bg-[#1C1917] border-b border-[#C5A059]/30">
          ...
          <div className="relative container-luxury py-14 sm:py-16 lg:py-20">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="max-w-2xl">
              ...
              <Link to="/products" className="btn-gold text-xs px-8 py-3.5 inline-flex items-center gap-2">
        ...
        {/* Values */}
        <section className="py-12 sm:py-16 lg:py-20 border-b border-[#C5A059]/15">
            ...
            <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
              {[
                ...
                <motion.div key={v.title} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                  className="bg-white dark:bg-[#1C1917] p-6 sm:p-8 border border-[#C5A059]/20 hover:border-[#C5A059] transition-all duration-300 text-center rounded-2xl">
        ...
        {/* Stats */}
        <section className="py-10 sm:py-12 lg:py-14 bg-[#4A0E17] text-[#FAF7F2] border-y border-[#C5A059]/30">
          <div className="container-luxury">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              {[
                ...
                <div key={label} className="text-center p-4 sm:p-6 bg-white/5 border border-[#C5A059]/30 rounded-xl">
                  <Icon className="w-5 h-5 text-[#C5A059] mx-auto mb-2" />
                  <p className="font-cormorant text-3xl sm:text-4xl font-bold text-[#E5C88A]">{value}</p>
                  <p className="font-sans text-[10px] sm:text-xs text-gray-300 uppercase tracking-widest mt-1">{label}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-12 sm:py-16 lg:py-20 text-center">
          <div className="container-luxury">
            <h2 className="font-cormorant text-3xl sm:text-4xl lg:text-5xl font-normal text-[#1C1917] dark:text-[#FAF7F2] mb-4">
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <Link to="/contact" className="btn-gold text-xs px-8 py-3.5">Get Directions to Store</Link>
              <a href="https://wa.me/919139236500" target="_blank" rel="noopener noreferrer" className="btn-wine text-xs px-8 py-3.5 border border-[#C5A059]">WhatsApp Consultation</a>
            </div>
          </div>
        </section>
      </main>
